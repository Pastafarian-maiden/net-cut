...
Our project works in a similar way that the original  NetCat works, in other words, we have creates a group chat. The project have the following features :
